...
{
    /// <inheritdoc />
    public partial class AddStorefronts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThemeConfig = table.Column<string>(type: "jsonb", nullable: false, defaultValue: "{}"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantOptionValues", x => new { x.VariantId, x.OptionValueId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carts_StoreId_SessionId",
                table: "Carts",
                columns: new[] { "StoreId", "SessionId" },
                unique: true);
