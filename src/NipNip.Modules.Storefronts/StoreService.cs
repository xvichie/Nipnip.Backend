...
public class StoreService(AppDbContext db, VercelDomainService vercel)
{
    ...
    private static readonly string[] KnownThemeIds = ["minimal", "bold", "classic", "luxury", "vibrant", "commerce", "editorial", "flower", "kids", "sports", "chocolate", "athletic", "handmade", "furniture", "varsity", "wooden", "industrial"];
